<?php
	...
	// a built-in PHP function: isset. returns true if the variable exists, false if not.
	if(isset($_GET['page'])) {
		$page = $_GET['page'];
	}
	else {
	...
	// in_array($needle, $haystack). returns true if the needle is in the haystack.
	// array_keys($array). returns an array of keys.

	// this function will let us know if the page passed in exists, and if not we'll send a 404 page.
